...
class VoterModel(Model):
    ...
    def getAllVotes(self):
        """
        Return the total votes which is equal to n_voters
        TODO: Remove this function,   fucntiton is not being used.
        """
        total = 0
    ...
    def poll(self):
        ...
        """
        resultPoll  = {}
        if self.currentPollCounter == 0 or self.voter_type == 'Honest' :# TODO :if we are using start_chance to determine the chancee that a voter will use a strategy, I believe that voter_type  is unnecessary
